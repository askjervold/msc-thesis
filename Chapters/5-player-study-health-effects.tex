...
\nice{Mention methods of transportation during play and kilometers "walked" in the game?}
...
\begin{figure}[h]
	...
	\caption{\todo{(Add explanation of colors to the figure)} A graph of physical activity before and after Pokémon GO}
...
\begin{table}[h]
	\centering
	\caption{\todo{(Yes/No to Improved Yes/No)} Mental conditions suffered by respondents and whether playing Pokémon GO has improved their condition}
