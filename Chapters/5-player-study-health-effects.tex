...
There were also reported other conditions, which are shown in Table \ref{tbl:other-mental-conditions-effect}.
...
\todo{Elaborate on "Yes" responses}

\todo{Mention the \emph{Both} and \emph{Opposite} cases}

\todo{Positive: Exercise and a sense of purpose}

\todo{Negative: Disappointment and negative behavior from opponents or outsiders}
