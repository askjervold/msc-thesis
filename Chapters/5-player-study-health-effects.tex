...
\begin{figure}[h]
	\centering
	\caption{\todo{Include picture of a hoverboard?}}
\end{figure}
...
\begin{figure}[h]
	...
	\begin{subfigure}[t]{0.4\textwidth}
		\centering
		%\includegraphics[height=1.2in]{Figures/a}
		\caption{\todo{Warning when moving too quickly to be on foot}}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.4\textwidth}
		\centering
		%\includegraphics[height=1.2in]{Figures/b}
		\caption{\todo{Warning on game start}}
	\end{subfigure}
	\caption{\todo{\emph{Do not play Pokémon GO while driving} in-game warnings}}
...
\begin{figure}[h]
	...
	\begin{subfigure}[t]{0.4\textwidth}
		\centering
		%\includegraphics[height=1.2in]{Figures/a}
		\caption{\todo{Loading screen encouraging players to remain aware of their surroundings while playing}}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.4\textwidth}
		\centering
		%\includegraphics[height=1.2in]{Figures/b}
		\caption{\todo{Warning on game start not to enter dangerous areas}}
	\end{subfigure}
