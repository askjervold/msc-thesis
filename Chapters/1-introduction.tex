...
In any evaluation of software, it is necessary to maintain metrics by which to evaluate strengths and weaknesses of the software. In line with the Goal-Question-Metric method (Basili, 1992 \cite{basili1992gqm}) \nice{(write more about the theory behind the approach?)}, to evaluate Pokémon GO, the following three research goals have been defined:
