...
\todo{Didn't ask about negative effect on mental conditions, perhaps more worsened than those who mentioned it specifically?}
...
\todo{Mention rounding of percentages leading to 99\% and 101\% totals.}

\todo{Mention randomized position of options to prevent bias}

\advice{Should I discuss what their "answer" means when someone doesn't answer an optional question?}

\advice{Should I discuss the presence and possible inaccuracy from small sample sizes (small categories for e.g. unlisted mental conditions and categories in success factors)?}

% Section 2 - General reflection on results
\section{Reflection on Results}

\todo{This section should reflect on the results, possibly with some personal speculation on the answers. }\advice{But couldn't all this just be in the conclusion?}
...
\todo{Physical health summary - some risks (especially playing and driving), but large increase in physical activity. Too bad it dropped off when players stopped playing.}
...
\nice{This section could discuss reactions from non-players (general attitudes in the community) and perhaps media.} \advice{Maybe not necessary? Probably don't have time.}
