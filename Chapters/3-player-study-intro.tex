...
\todo{Fix intro to make clear that survey questions were made to answer research questions. The final version of the survey can be found in Appendix \ref{appendix:survey}.}
...
\todo{Make a short mention of the results normalized for responses per gender: More popular among males in the younger categories and females in the older categories (even in the middle). Matches observations of groups of young boys playing but few young girls, and maybe a reference to women of advanced ages and walking groups}
...
\todo{Include stats on the in-game level of the respondents}
